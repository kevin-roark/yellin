...
- (void)viewDidLoad {
    ...
    UIView *whoDescriptionFrame = [[UIView alloc] initWithFrame:CGRectMake(10, y, self.view.frame.size.width - 20, 240)];
    ...
    [whoText appendString:@"Who is makin' all these crazy cool mouth sounds? The people who made this thing - "];
    [whoText appendString:@"MILLER'S FANTASY: Kevin, Dylan, and Henry (and ole Big Ben with the nice icons)."];
    ...
    NSMutableString *thanksText = [NSMutableString stringWithString:@"Thanks for playing with this and listening to special sounds!! Seriously!!!"];
